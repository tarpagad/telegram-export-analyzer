  ...
  return (
    <footer className="footer items-center p-4 bg-base-100">
      <div className="items-center grid-flow-col">
        ...
        <p>By Jean Didier <a href='https://github.com/fraol0912' target='_blank'>Credits</a></p>
      </div>
      <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        <a href="https://twitter.com/tarpagad" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <a href="https://github.com/tarpagad/" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <a href="www.linkedin.com/in/tarpaga/" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <a href="https://t.me/tarpagajd" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
